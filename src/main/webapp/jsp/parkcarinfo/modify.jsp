...
<body>
<h3>当前位置：停车场车位信息</h3>
<a href="${pageContext.request.contextPath}/parkcarinfo?method=query" style="text-align: right">返回</a>
<a href="${pageContext.request.contextPath}/logout" style="text-align: right">退出</a>


<form action="${pageContext.request.contextPath}/parkcarinfo?method=${param.parkNo == null  ? 'create' : 'update'}" method="post">
