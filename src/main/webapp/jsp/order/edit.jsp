...
<body>
<h3>当前位置：订单管理</h3>
<a href="${pageContext.request.contextPath}/order?action=query" style="text-align: right">返回</a>
<a href="${pageContext.request.contextPath}/logout" style="text-align: right">退出</a>
<form action="${pageContext.request.contextPath}/order?action=${param.id == null ? 'create' : 'update'}" method="post">
